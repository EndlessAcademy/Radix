...
--- RADIX PLUS SETTINGS ---
local Show_Button = false -- Shows the button for toggle radix ui manually. If "false", works only on mobile, if "true", works everytime.
local Button_Icon = "" -- Icon of the button for toggle radix ui
----------------------------
...
local SaveManager = {} do
	SaveManager.Folder = "RadixSettings"
	SaveManager.Ignore = {}
	SaveManager.Parser = {
		Toggle = {
...
local InterfaceManager = {} do
	InterfaceManager.Folder = "RadixSettings"
